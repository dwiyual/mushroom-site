...
function Tagline() {
    return (
        <div id='Company-Mission'>
            <h1 className="Tagline">Nature's pharmacy, delivered to your door!</h1>
            <p>Welcome to Nature's Pharmacy, your one-stop-shop for the best in medicinal and gourmet edible mushrooms. At Nature's Pharmacy, we're passionate about harnessing the power of mushrooms to promote optimal health and wellness. Our mission is simple: to provide our customers with the highest quality, sustainably-sourced mushroom products that help you feel your best, inside and out.

                We believe that mushrooms are one of nature's most powerful superfoods, with a wealth of health benefits that have been known for centuries. From boosting your immune system to promoting healthy digestion and cognitive function, mushrooms have been used for medicinal purposes for thousands of years. But they're not just good for you - they're delicious, too! At Nature's Pharmacy, we offer a wide selection of gourmet edible mushrooms, perfect for cooking up a tasty and nutritious meal.
